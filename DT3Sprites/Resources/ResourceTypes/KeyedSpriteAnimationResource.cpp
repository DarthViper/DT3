...
GLOBAL_STATIC_INITIALIZATION(0,KeyedSpriteAnimationResource::initialize_static())
GLOBAL_STATIC_DESTRUCTION(0,KeyedSpriteAnimationResource::uninitialize_static())
...
void KeyedSpriteAnimationResource::initialize_static (void)
{
    SystemCallbacks::reload_resources_cb().add(make_callback(&type::reload_if_changed));
}

void KeyedSpriteAnimationResource::uninitialize_static (void)
{
