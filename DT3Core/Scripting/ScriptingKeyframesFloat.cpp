//==============================================================================
///	
///	File: ScriptingKeyframesFloat.cpp
///	
...
#include "DT3Core/Scripting/ScriptingKeyframesFloat.hpp"
...
IMPLEMENT_FACTORY_CREATION(ScriptingKeyframesFloat)
IMPLEMENT_PLUG_NODE(ScriptingKeyframesFloat)
...
BEGIN_IMPLEMENT_PLUGS(ScriptingKeyframesFloat)
...
ScriptingKeyframesFloat::ScriptingKeyframesFloat (void)
...
ScriptingKeyframesFloat::ScriptingKeyframesFloat (const ScriptingKeyframesFloat &rhs)
...
ScriptingKeyframesFloat & ScriptingKeyframesFloat::operator = (const ScriptingKeyframesFloat &rhs)
{
...
int32_t  ScriptingKeyframesFloat::set_key_time (int32_t k, DTfloat time)
{
	PROFILER(SCRIPTING);
...
void  ScriptingKeyframesFloat::clear_key (int32_t k)
{
	PROFILER(SCRIPTING);
...
void ScriptingKeyframesFloat::set_key (void)
{
	PROFILER(SCRIPTING);
	...
	if (outgoing.size() > 0) {
		...
		Plug<DTfloat> *outplug = static_cast<Plug<DTfloat>*>(*(outgoing.begin()));
		
		// get the value of the first connected plug
		DTfloat val = outplug->value_without_compute();
...
void ScriptingKeyframesFloat::clear_key (void)
{
	PROFILER(SCRIPTING);
