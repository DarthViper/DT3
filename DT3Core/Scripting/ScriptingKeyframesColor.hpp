#pragma once
#ifndef DT3_SCRIPTINGKEYFRAMESCOLOR
#define DT3_SCRIPTINGKEYFRAMESCOLOR
//==============================================================================
///
///	File: ScriptingKeyframesColor.hpp
///
...
//==============================================================================
/// Keyframes for Color type.
//==============================================================================

class ScriptingKeyframesColor: public ScriptingKeyframes {
    public:
        DEFINE_TYPE(ScriptingKeyframesColor,ScriptingKeyframes)
        DEFINE_CREATE_AND_CLONE
        DEFINE_PLUG_NODE

                                    ScriptingKeyframesColor	(void);
                                    ScriptingKeyframesColor	(const ScriptingKeyframesColor &rhs);
        ScriptingKeyframesColor &	operator =				(const ScriptingKeyframesColor &rhs);
        virtual						~ScriptingKeyframesColor(void);
