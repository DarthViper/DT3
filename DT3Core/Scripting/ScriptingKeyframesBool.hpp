#pragma once
#ifndef DT3_SCRIPTINGKEYFRAMESBOOL
#define DT3_SCRIPTINGKEYFRAMESBOOL
//==============================================================================
///
///	File: ScriptingKeyframesBool.hpp
///
...
//==============================================================================
/// Keyframes for Bool type.
//==============================================================================

class ScriptingKeyframesBool: public ScriptingKeyframes {
    public:
        DEFINE_TYPE(ScriptingKeyframesBool,ScriptingKeyframes)
        DEFINE_CREATE_AND_CLONE
        DEFINE_PLUG_NODE

                                    ScriptingKeyframesBool	(void);
                                    ScriptingKeyframesBool	(const ScriptingKeyframesBool &rhs);
        ScriptingKeyframesBool &	operator =				(const ScriptingKeyframesBool &rhs);
        virtual						~ScriptingKeyframesBool (void);
