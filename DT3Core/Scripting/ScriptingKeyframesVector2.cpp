...
IMPLEMENT_FACTORY_CREATION_SCRIPT(ScriptingKeyframesVector2,"",EdScriptingKeyframesVector2Adapter)
IMPLEMENT_PLUG_NODE(ScriptingKeyframesVector2)
...
ScriptingKeyframesVector2 & ScriptingKeyframesVector2::operator = (const ScriptingKeyframesVector2 &rhs)
{
...
DTint  ScriptingKeyframesVector2::set_key_time (DTint k, DTfloat time)
{
	PROFILER(SCRIPTING);
...
void  ScriptingKeyframesVector2::clear_key (DTint k)
{
	PROFILER(SCRIPTING);
