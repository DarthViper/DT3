...
int32_t  ScriptingKeyframesVector3::set_key_time (int32_t k, DTfloat time)
{
	PROFILER(SCRIPTING);
...
void  ScriptingKeyframesVector3::clear_key (int32_t k)
{
	PROFILER(SCRIPTING);
...
bool ScriptingKeyframesVector3::compute (const PlugBase *plug)
{
	PROFILER(SCRIPTING);
