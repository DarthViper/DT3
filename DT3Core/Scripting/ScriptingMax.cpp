...
#include "DT3Core/Scripting/ScriptingMax.hpp"
...
IMPLEMENT_FACTORY_CREATION_SCRIPT(ScriptingMax,"Math",NULL)
IMPLEMENT_PLUG_NODE(ScriptingMax)
...
BEGIN_IMPLEMENT_PLUGS(ScriptingMax)
...
ScriptingMax::ScriptingMax (void)
...
ScriptingMax::ScriptingMax (const ScriptingMax &rhs)
    :   ScriptingBase	(rhs),
		_in1			(rhs._in1),
		_in2			(rhs._in2),
		_out			(rhs._out)
...
ScriptingMax & ScriptingMax::operator = (const ScriptingMax &rhs)
{
