...
class EdSpriteMainWindow : public QMainWindow
{
    ...
    public:
        ...
        /// \param param description
        /// \return description
        const std::list<KeyedSpriteAnimationPoseJoint*>&  getPartSelection   (void);

        /// Description
        /// \param param description
        /// \return description
        void                                    setPartSelection        (const std::list<KeyedSpriteAnimationPoseJoint*> &selection);
    ...
    private:
        ...
        struct UndoQueueEntry {
            std::shared_ptr<KeyedSpriteResource>           sprite;
            std::shared_ptr<KeyedSpriteAnimationResource>  animation;
        };
        std::list<UndoQueueEntry>                    _undo_queue;
        ...
        std::list<KeyedSpriteAnimationPoseJoint*>    _selection;
        ...
        void                                    fireEvents (const QString &event_id, const QString &event_parameter);
