...
EdLevelPropertyVector3Field::EdLevelPropertyVector3Field (EdLevelPropertiesWindow *parent, std::shared_ptr<PlugNode> node, std::shared_ptr<ArchiveData> data)
{
...
void EdLevelPropertyVector3Field::doReadParams(void)
{
    blockSignals(true);
...
void EdLevelPropertyVector3Field::doKeyframePressed (void)
{
